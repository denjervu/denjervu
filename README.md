# 👋 Привет, я Денис Жеребцов, QA-инженер

Это портфолио QA-инженера: тестовая документация, автотесты, API-тестирование (Postman) и SQL-запросы.

Здесь же — информация обо мне, стек, резюме и контакты.

## 👨‍💻 Обо мне

QA-инженер с опытом более года в ручном тестировании веб-приложений. Тестирую функционал, интеграции и API, использую SQL для проверки данных.

## 📁 [Портфолио](https://github.com/denjervu/qa-portfolio)
...
<div style="text-align: center;">
    <a href="https://www.linkedin.com/in/denis-jerebtsov/" target="_blank">
    <img src="contacts_logo/LinkedIn.png" alt="LinkedIn" title="LinkedIn" width="50" height="50">
    </a>
...
## 📄 Резюме
[Jerebtsov_Denis_QA_CV.pdf](CV.pdf)
___

## 📜 [Сертификаты](https://github.com/denjervu/my_certificates)
